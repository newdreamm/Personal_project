...
#win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../../../mysql/Connector_C++_8.0/lib64/release/ -lmysqlcppconn
#else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../../../mysql/Connector_C++_8.0/lib64/debug/ -lmysqlcppconn
#else:unix: LIBS += -L$$PWD/../../../../mysql/Connector_C++_8.0/lib64/ -lmysqlcppconn

#INCLUDEPATH += $$PWD/../../../../mysql/Connector_C++_8.0/include
#DEPENDPATH += $$PWD/../../../../mysql/Connector_C++_8.0/include
